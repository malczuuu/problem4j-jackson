...
- `v2.0.x` (`main` branch),
- `v1.4.x` (`release-v1.4.x` branch, until `2026-12-31`).
...
designed to remain dependency-light and avoid dictating the user's Jackson version. This helps to ensure maximum
